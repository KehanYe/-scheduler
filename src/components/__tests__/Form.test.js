...
describe('Form', () => {
	...
	it('renders with initial student name', () => {
		const { getByTestId } = render(<Form interviewers={interviewers} student="kehanfu" />);
		expect(getByTestId('student-name-input')).toHaveValue('kehanfu');
	});
	...
	// 	const onSave = jest.fn();
	// 	const { getByText, getByPlaceholderText } = render(<Form interviewers={interviewers} onSave={onSave} interviewer={interviewers[0].id}/>);
